...
import { BranchOfficeComponent } from 'app/entities/branch-office/branch-office.component';
...
describe('Component Tests', () => {
  describe('BranchOffice Management Component', () => {
    let comp: BranchOfficeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(BranchOfficeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.branchOffices[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
